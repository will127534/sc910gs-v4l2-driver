# Kernel Driver for SC910GS

This guide provides detailed instructions on how to install the SC910GS kernel driver on a Linux system, specifically Raspbian.
...
cam0 support is available with
```
camera_auto_detect=0
dtoverlay=sc910gs,cam0
```
